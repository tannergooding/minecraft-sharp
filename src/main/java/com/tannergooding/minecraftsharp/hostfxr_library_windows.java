...
public interface hostfxr_library_windows extends Library
{
    ...
    public static class hostfxr_initialize_parameters extends Structure
    {
        ...
        public hostfxr_initialize_parameters(Pointer size, WString host_path, WString dotnet_root)
        {
            super();
    ...
    {
        void apply(WString message);
    }

    public interface hostfxr_get_runtime_property_value_fn extends Callback
    {
        int apply(Pointer host_context_handle, WString name, PointerByReference value);
    }

    int hostfxr_main(int argc, PointerByReference argv);

    int hostfxr_main_startupinfo(int argc, PointerByReference argv, WString host_path, WString dotnet_root, WString app_path);
    ...
    int hostfxr_initialize_for_runtime_config(WString runtime_config_path, hostfxr_initialize_parameters.ByReference parameters, PointerByReference host_context_handle);

    int hostfxr_set_runtime_property_value(Pointer host_context_handle, WString name, WString value);
